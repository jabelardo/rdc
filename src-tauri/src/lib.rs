...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::branches::delete_local_branch,
            commands::branches::get_branches_pointed_at,
            commands::branches::get_merged_branches,
            commands::branches::delete_ref,
            commands::branches::get_symbolic_ref,
            commands::changes::reset,
            commands::changes::reset_paths,
            commands::changes::unstage_all,
            commands::changes::unstage_all_files,
            commands::conflicts::stage_resolved_conflict_files,
            commands::history::get_ahead_behind,
            commands::diffs::get_branch_merge_base_diff,
            commands::diffs::get_branch_merge_base_changed_files,
            commands::diffs::get_commit_range_changed_files,
            commands::changes::get_status,
            commands::repositories::init_repository,
            commands::hooks::abort_hook,
            commands::hooks::resolve_hook_failure,
            commands::changes::create_commit,
            commands::changes::create_merge_commit,
            commands::branches::checkout_branch,
            commands::branches::checkout_remote_branch,
            commands::history::checkout_commit,
            commands::changes::checkout_paths,
            commands::history::get_commits,
            commands::history::get_commit,
            commands::history::get_changed_files,
            commands::branches::get_branches,
            commands::branches::get_branches_differing_from_upstream,
            commands::changes::get_index_changes,
            commands::diffs::get_working_directory_diff,
            commands::diffs::get_commit_diff,
            commands::diffs::get_commit_range_diff,
            commands::changes::discard_changes_from_selection,
            commands::remotes::push,
            commands::remotes::delete_remote_branch,
            commands::remotes::fetch,
            commands::remotes::fetch_workflow,
            commands::remotes::fetch_refspec,
            commands::remotes::pull,
            commands::remotes::fast_forward_branches,
            commands::remotes::clone,
            commands::remotes::get_remotes,
            commands::remotes::add_remote,
            commands::remotes::remove_remote,
            commands::remotes::set_remote_url,
            commands::remotes::get_remote_url,
            commands::remotes::update_remote_head,
            commands::remotes::get_remote_head,
            ...
            commands::history::get_cherry_pick_snapshot,
            commands::history::continue_cherry_pick,
            commands::history::abort_cherry_pick,
            commands::submodules::list_submodules,
            commands::submodules::reset_submodule_paths,
            commands::history::squash,
            commands::history::reorder,
            commands::tags::create_tag,
            commands::tags::delete_tag,
            commands::tags::get_all_tags,
            commands::history::revert_commit,
            commands::history::abort_revert,
            commands::branches::get_recent_branches,
            commands::branches::get_branch_checkouts,
            commands::repositories::get_description,
            commands::repositories::write_description,
            commands::repositories::get_author_identity,
            commands::changes::clean_untracked_files,
            commands::repositories::add_safe_directory,
            commands::branches::determine_mergeability,
            commands::repositories::get_repository_type,
            commands::history::is_cherry_pick_head_found,
            commands::branches::get_rebase_internal_state,
            ...
            commands::changes::checkout_index,
            commands::trailers::get_trailer_separator_characters,
            commands::trailers::parse_trailers,
            commands::trailers::merge_trailers,
            ...
            commands::repositories::get_config_value,
            commands::repositories::get_global_config_path,
            commands::gitignore::read_gitignore_at_root,
            commands::gitignore::save_gitignore,
            commands::gitignore::append_ignore_rules,
            commands::gitignore::append_ignore_files,
            commands::lfs::install_global_lfs_filters,
            commands::lfs::install_lfs_hooks,
            commands::lfs::is_using_lfs,
            commands::branches::merge_branch,
            commands::branches::get_merge_base,
            commands::conflicts::abort_merge,
            commands::branches::rebase_branch,
            commands::branches::continue_rebase,
            commands::branches::abort_rebase,
            commands::branches::get_rebase_snapshot,
        ])
