...
import { ITrailer, isCoAuthoredByTrailer } from "./trailer";
...
function trimCoAuthorsTrailers(trailers: ReadonlyArray<ITrailer>, body: string) {
...
export class Commit {
  ...
  public constructor(
    ...
    this.authoredByCommitter =
      this.author.name === this.committer.name && this.author.email === this.committer.email;
