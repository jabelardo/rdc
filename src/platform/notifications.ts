...
function isNotificationEventPayload(value: unknown): value is NotificationEventPayload {
...
export async function onNotificationEvent(callback: NotificationCallback): Promise<UnlistenFn> {
