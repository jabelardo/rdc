...
describe("formatNumber", () => {
  describe("integers", () => {
    ...
    it("formats thousands with comma separator", () => {
      ...
      assert.strictEqual(formatNumber(12345, commaThousandsDotDecimal), "12,345");
      assert.strictEqual(formatNumber(999999, commaThousandsDotDecimal), "999,999");
    });

    it("formats millions with multiple separators", () => {
      assert.strictEqual(formatNumber(1000000, commaThousandsDotDecimal), "1,000,000");
      assert.strictEqual(formatNumber(1234567890, commaThousandsDotDecimal), "1,234,567,890");
    });
    ...
    it("formats thousands with dot separator (European style)", () => {
      ...
      assert.strictEqual(formatNumber(12345, dotThousandsCommaDecimal), "12.345");
      assert.strictEqual(formatNumber(1234567, dotThousandsCommaDecimal), "1.234.567");
    });

    it("formats thousands with space separator", () => {
      assert.strictEqual(formatNumber(1000, spaceThousandsDotDecimal), "1 000");
      assert.strictEqual(formatNumber(12345, spaceThousandsDotDecimal), "12 345");
      assert.strictEqual(formatNumber(1234567, spaceThousandsDotDecimal), "1 234 567");
    });
  ...
  describe("decimals", () => {
    ...
    it("formats large numbers with decimals", () => {
      assert.strictEqual(formatNumber(1234567.89, commaThousandsDotDecimal), "1,234,567.89");
      assert.strictEqual(formatNumber(1234567.89, dotThousandsCommaDecimal), "1.234.567,89");
      assert.strictEqual(formatNumber(1234567.89, spaceThousandsDotDecimal), "1 234 567.89");
    });
  ...
  describe("negative numbers", () => {
    it("formats negative integers", () => {
      assert.strictEqual(formatNumber(-1, commaThousandsDotDecimal), "-1");
      assert.strictEqual(formatNumber(-1000, commaThousandsDotDecimal), "-1,000");
      assert.strictEqual(formatNumber(-1234567, commaThousandsDotDecimal), "-1,234,567");
    });

    it("formats negative decimals", () => {
      assert.strictEqual(formatNumber(-1.5, commaThousandsDotDecimal), "-1.5");
      assert.strictEqual(formatNumber(-1234.56, commaThousandsDotDecimal), "-1,234.56");
    });
  });

  describe("edge cases", () => {
    it("handles Infinity", () => {
      assert.strictEqual(formatNumber(Infinity, commaThousandsDotDecimal), "Infinity");
      assert.strictEqual(formatNumber(-Infinity, commaThousandsDotDecimal), "-Infinity");
    });
    ...
    it("handles very small decimals", () => {
      ...
      assert.strictEqual(formatNumber(0.000001, commaThousandsDotDecimal), "0.000001");
    });
  });
});
...
describe("formatCompactNumber", () => {
  describe("small numbers (< 1000)", () => {
    it("formats small numbers without compaction", () => {
      assert.strictEqual(formatCompactNumber(0, { numberFormat: commaThousandsDotDecimal }), "0");
      assert.strictEqual(formatCompactNumber(1, { numberFormat: commaThousandsDotDecimal }), "1");
      assert.strictEqual(formatCompactNumber(42, { numberFormat: commaThousandsDotDecimal }), "42");
      assert.strictEqual(
