import { Fragment, useCallback, useRef, type CSSProperties, type ReactNode } from "react";
...
export function VirtualList<T>({
  ...
  return (
    <div ref={viewportRef} className="virtual-list-viewport" data-virtualized={virtualized}>
      <ul
        ref={listRef}
        className={className}
