...
export function isConflictedFile(file: AppFileStatus): file is ConflictedFileStatus {
 ...
 */
export function hasConflictedFiles(workingDirectoryStatus: WorkingDirectoryStatus): boolean {
