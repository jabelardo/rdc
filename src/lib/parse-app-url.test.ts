...
import { parseAppURL, IOpenRepositoryFromURLAction, IOAuthAction } from "./parse-app-url";
...
describe("parseAppURL", () => {
  ...
  describe("openRepo via SSH", () => {
    it("returns right name", () => {
      const result = parseAppURL("github-mac://openRepo/git@github.com/desktop/desktop");
      assert.equal(result.name, "open-repository-from-url");
