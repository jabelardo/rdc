...
export type URLActionType = IOAuthAction | IOpenRepositoryFromURLAction | IUnknownAction;
 ...
 */
function getQueryStringValue(query: ParsedUrlQueryWithUndefined, key: string): string | null {
