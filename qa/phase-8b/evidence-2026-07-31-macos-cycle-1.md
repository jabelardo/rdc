...
- `pnpm test`: passed; 939 tests in 110 files
...
- `cargo test --workspace`: passed; 1,179 tests
...
- Baseline application-shell layout: blocked — `baseline-layout-checklist.md`
